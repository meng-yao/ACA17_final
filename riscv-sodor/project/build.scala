...
object BuildSettings extends Build {
  ...
  lazy val common = Project("common", file("common"), settings = buildSettings
    ++Seq(scalaSource in Compile := file("/home/yao/桌面/M1-2/ACA_Project/ACA17_final/riscv-sodor/src/common")))
  lazy val rv32_1stage = Project("rv32_1stage", file("rv32_1stage"), settings = buildSettings ++ chipSettings
    ++Seq(scalaSource in Compile := file("/home/yao/桌面/M1-2/ACA_Project/ACA17_final/riscv-sodor/src/rv32_1stage"))) dependsOn(common)
  lazy val rv32_2stage = Project("rv32_2stage", file("rv32_2stage"), settings = buildSettings ++ chipSettings
    ++Seq(scalaSource in Compile := file("/home/yao/桌面/M1-2/ACA_Project/ACA17_final/riscv-sodor/src/rv32_2stage"))) dependsOn(common)
  lazy val rv32_3stage = Project("rv32_3stage", file("rv32_3stage"), settings = buildSettings ++ chipSettings
    ++Seq(scalaSource in Compile := file("/home/yao/桌面/M1-2/ACA_Project/ACA17_final/riscv-sodor/src/rv32_3stage"))) dependsOn(common)
  lazy val rv32_5stage = Project("rv32_5stage", file("rv32_5stage"), settings = buildSettings ++ chipSettings
    ++Seq(scalaSource in Compile := file("/home/yao/桌面/M1-2/ACA_Project/ACA17_final/riscv-sodor/src/rv32_5stage"))) dependsOn(common)
  lazy val rv32_ucode  = Project("rv32_ucode", file("rv32_ucode"), settings = buildSettings ++ chipSettings
    ++Seq(scalaSource in Compile := file("/home/yao/桌面/M1-2/ACA_Project/ACA17_final/riscv-sodor/src/rv32_ucode"))) dependsOn(common)
